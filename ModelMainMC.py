...
Sample Run Command:
python ModelMainMC.py --output-path /Users/robert/Desktop/outputs --experiment-name test1

Local Command:
python ModelMainMC.py --output-path /Users/robert/Desktop/outputs --experiment-name randomtest2 --run-parallel False --do-ExSTraCS True --do-NB True --do-LR True --do-KN True --subsample 1000
'''

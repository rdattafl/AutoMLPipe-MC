...
License: GPL 3.0
Description: Phase 4 of AutoMLPipe-MC - This 'Main' script manages Phase 4 run parameters, updates the metadata file (with user specified run parameters across pipeline run)
...
Warnings: Designed to be run following the completion of AutoMLPipe-MC Phase 3 (FeatureImportanceMain.py).

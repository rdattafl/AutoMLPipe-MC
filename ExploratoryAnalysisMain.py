...
License: GPL 3.0
Description: Phase 1 of AutoMLPipe-MC - This 'Main' script manages Phase 1 run parameters, updates the metadata file (with user specified run parameters across pipeline run)
             ...
             exploratory analysis of data and cross validation (CV) partitioning. Note that this entire pipeline may also be run within Jupyter Notebook (see AutoMLPipe-BC-Notebook.ipynb).

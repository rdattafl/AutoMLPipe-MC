...
License: GPL 3.0
Description: Phase 3 of AutoMLPipe-MC - This 'Main' script manages Phase 3 run parameters, updates the metadata file (with user specified run parameters across pipeline run)
...
Warnings: Designed to be run following the completion of AutoMLPipe-MC Phase 2 (DataPreprocessingMain.py).
